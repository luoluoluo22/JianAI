...
import {
  ...
  Sparkles, Link2, Type, KeyRound, // EFFECTS HIDDEN: removed Search
      ...
      <MenuBar menus={menuDefinitions} rightContent={
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded text-[12px] text-zinc-400 transition-colors hover:text-zinc-200 hover:bg-zinc-800/50"
